...
#Create demo cluster:
k3d cluster create nodeports-demo
...
# Update the k3d cluster to map the node ports 30000 to 30005 to the host machine
k3d cluster edit nodeports-demo --port-add 30000-30005:30000-30005@loadbalancer
...
k3d cluster delete nodeports-demo

k3d cluster create nodeports-demo --port 30000-30005:30000-30005@loadbalancer
